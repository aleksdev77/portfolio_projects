...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2021-12-18');
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('#width', '#height');
...
var changeModalState = function changeModalState(state) {
  // (state) Сбор данных в модальных окнах
...
var forms = function forms(state) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(fetch(url, {
              // Скрипту необходимо дождаться окончания запроса
              method: "POST",
              body: data
            }));
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); // Собираем все данные из формы в конструктор FormData
...
var modals = function modals() {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          // Закрытие всех модалок если происходит наслоение
        ...
        if (e.target.classList.contains('popup_calc_profile_button') || e.target.classList.contains('popup_engineer_btn') || e.target.classList.contains('phone_link')) {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 7000);
};
