...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])('#lovers');
...
var accordion = function accordion() {
  var accordion = document.querySelector('#accordion'),
      ...
      accordionSpan = document.querySelectorAll('.accordion-heading span'); // Скрытие всех блоков    
  ...
  function hideBlocks() {
    ...
    accordionSpan.forEach(function (span) {
  ...
  accordion.addEventListener('click', function (e) {
    var target = e.target;
    var parentNode = target.parentNode; // Получаю тег p - родителя тега span

    var nextNode = parentNode.nextElementSibling; // Получаю div
    ...
    if (target.tagName === "SPAN" && !target.classList.contains('active-style')) {
      ...
      nextNode.classList.add('animated', 'fadeOutDown'); // nextNode.style.maxHeight = '0px';
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (menuElem.style.display == "none" && window.screen.availWidth < 4000) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    var endSum = resultBlock.textContent;
...
/* harmony default export */ __webpack_exports__["default"] = (drop); // События перетаскивания элементов, файлов

/*
    drag *
    dragend *
    dragenter - событие возникает, когда объект перетаскивается над dropArea
    dragexit *
    dragleave - объект перетащили за пределы dropArea
    dragover - объект зависает или двигается в пределах dropArea
    dragstart *
    drop - объект отправлен в dropArea, возникает в момент отпускания кнопки мыши

    * - срабатывают на DOM элементах которые перетаскивают внутри страницы
    (не относится к файлам с компьютера)
*/
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    ...
    item.addEventListener('input', function () {
      ...
      var dots;
      var itemFiles = item.files[0].name.split('.'); // Разделение файла на до точки и после точки

      itemFiles[0].length > 5 ? dots = "..." : dots = ".";
      var name = itemFiles[0].substring(0, 6) + dots + itemFiles[1];
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (e) {
      ...
      var statusImg = document.createElement('img'); // Изображение при отправки формы
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          // Закрытие всех модалок что бы избежать наслоения
          item.style.display = 'none';
    ...
    close.addEventListener('click', function () {
      closeModals();
      setTimeout(function () {
        // Появление скролла через 0.6 секунды
        document.body.style.overflow = '';
...
var showMoreStyles = function showMoreStyles(trigger) {
  ...
  function createCards(response) {
    ...
    response.forEach(function (item) {
      // Ответ содержит в себе массив данных
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function showSlides(n) {
    if (n > items.length) {
      // если следующий слайд превышает общее кол.-во слайдов тогда вернется к первому слайду
      slideIndex = 1;
    }

    if (n < 1) {
      slideIndex = items.length; // если меньше 1 показывается последний слайд
    }
    ...
    items[slideIndex - 1].style.display = 'block'; // Функция скроет все неактивные слайды и покажет первый слайд
  }
  ...
  try {
    // Конструкция позволяет предотвратить поломку скрипта
    var prevBtn = document.querySelector(prev),
        nextBtn = document.querySelector(next); // Перелистывает слайды горизонтально
  ...
  } catch (e) {} // Вертикальное перелистывание слайдов, функция остановки авто. прокрутки при наведении мыши


  function activateAnimation() {
    if (dir === 'vertical') {
      paused = setInterval(function () {// plusSlides(1);                
